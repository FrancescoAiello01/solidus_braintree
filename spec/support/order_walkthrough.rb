...
module SolidusBraintree
  class OrderWalkthrough
    ...
    def address(order)
      order.bill_address = ::FactoryBot.create(:solidus_braintree_address, :with_fixed_zipcode, country: @country, state: @state)
      order.ship_address = ::FactoryBot.create(:solidus_braintree_address, :with_fixed_zipcode, country: @country, state: @state)
      order.next!
    end
