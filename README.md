...
2. Run `bin/rails g solidus_braintree:install`. This will update some references to SolidusPaypalBraintree in your app. It will also add a data migration to update your database. However, you'll need to uncomment the code in the migration to enable it.
