...
1. Change the gem in your Gemfile from `gem 'solidus_paypal_braintree'` to `gem 'solidus_braintree', '~> 2.0.0'`.
2. Run `bin/rails g solidus_braintree:install`. This will update some references to SolidusPaypalBraintree in your app including records in your database.
